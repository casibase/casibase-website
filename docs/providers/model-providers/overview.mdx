...
- **Claude**: Anthropic's advanced models including the latest Opus 4.5 with 200K context window
- **DeepSeek**: Cost-effective Chinese LLM with chat and reasoning capabilities
- **Moonshot (Kimi)**: Supports various context sizes and the new Kimi-v2 series with thinking models
