...
**OpenAI** — GPT-3.5, GPT-4, and o1 series with web search and step-by-step reasoning displays

**Azure OpenAI** — OpenAI models through Azure's infrastructure with official SDK integration

**Alibaba Cloud** — Qwen models and DeepSeek's latest releases (v3, v3.1, v3.2, R1) with web search support

**DeepSeek** — Direct access to DeepSeek's reasoning models
