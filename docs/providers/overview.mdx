...
+ Claude: e.g. claude-2, claude-instant-v1, claude-opus-4-5
+ Ernie: e.g. ERNIE-Bot, ERNIE-Bot-turbo
+ Alibaba Cloud: e.g. qwen-max, deepseek-v3.2, deepseek-r1
+ DeepSeek: e.g. deepseek-chat (v3.2), deepseek-reasoner
+ Moonshot: e.g. moonshot-v1-8k, kimi-k2-thinking, kimi-latest
