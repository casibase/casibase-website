...
Provider configurations require API keys or secrets for authentication. Casibase automatically masks these sensitive fields when you enter them, displaying them as password fields with toggle visibility. This prevents accidental exposure of your credentials while still allowing you to verify entries when needed.
...
**DeepSeek** — Direct access to the v3.x series and R1 reasoning models

**Claude** — Anthropic's Claude 2 and Claude Instant models
