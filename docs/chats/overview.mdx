...
- **AI Reasoning**: When the AI uses reasoning or tool-calling capabilities, these messages appear in collapsible cards. Click to expand or collapse the reasoning details to keep the conversation focused on the final responses.
