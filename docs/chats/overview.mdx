...
Each chat automatically tracks token usage and creates transaction records for billing. The model provider field helps identify which AI service handled the conversation, making it easier to monitor costs across different providers.
